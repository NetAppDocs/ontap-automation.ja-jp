...
NetApp ONTAP PowerShell Toolkitは、2,400以上のコマンドレットを含むモジュールでローカルPowerShell環境を強化します。これにより、Windowsホスト用のコードを迅速に開発して、ONTAPデプロイメントを自動化できます。詳細については、link:../pstk/learn-about-pstk.html["NetApp ONTAP PowerShell ツールキットについて"]を参照してください。
